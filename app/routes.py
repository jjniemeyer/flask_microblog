...
def follow(username):
    ...
    if form.validate_on_submit():
        ...
        current_user.follow(user)  # note this function is User.follow not a recursive call to this follow
        db.session.commit()
...
def reset_password_request():
    ...
    if form.validate_on_submit():
        ...
        flash(_('Check your email for instructions on how to reset password.'))
        return redirect(url_for('login'))
